...
const WHATSAPP_BASE_MSG =
  "Hello Tramboo Home, I’m interested in a custom furniture piece and would like to discuss details.";
    ...
    >
      <div className="tram-container">
        <div className="flex items-center justify-between border-b border-border/60 py-5">
          ...
          >
            <span className="tram-display text-lg font-semibold tracking-tight">
              tramboo
            </span>
            <span className="text-xs text-muted-foreground tram-kicker">
              Home
            </span>
          </Link>
...
function Hero() {
  ...
  return (
    <section
      className="tram-container pt-14 md:pt-20"
    ...
    >
      <div className="grid items-start gap-10 lg:grid-cols-[1.05fr,0.95fr]">
        <div>
          ...
          >
            tramboo crafts river tables, dining tables, chairs, and one-of-one
            commissions in walnut, elm, and premium hardwoods—designed to age
            beautifully.
          </p>
          ...
          >
            {[
              ...
              >
                <div className="tram-kicker text-[10px] text-muted-foreground">
                  {m.label}
                </div>
            ...
            <div className="absolute inset-x-0 bottom-0 p-5">
              <div className="rounded-2xl border border-border/70 bg-background/70 px-6 py-5 backdrop-blur-xl">
                <div className="flex flex-col gap-1">
                  <div
                    className="tram-kicker text-[10px] text-muted-foreground uppercase tracking-widest"
                    data-testid="text-hero-caption-kicker"
                  >
                    Featured piece
                  </div>
                  <div
                    className="mt-1 text-base font-medium"
                    data-testid="text-hero-caption-title"
                  >
                    Studio Series — Walnut & linen tones
                  </div>
                  <div
                    className="mt-2 text-[11px] text-muted-foreground uppercase tracking-wider"
                    data-testid="text-hero-caption-meta"
                  >
...
function Featured() {
  ...
  return (
    <section
      className="tram-container mt-16 md:mt-24"
      data-testid="section-featured"
    >
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        <div>
          <div
            className="tram-kicker text-xs text-muted-foreground mb-3"
            data-testid="text-featured-kicker"
          >
            Limited selections
          </div>
          <h2
            className="tram-display text-3xl md:text-4xl font-semibold leading-tight"
          ...
          >
            ...
            >
              <div className="relative">
                ...
                />
                <div
                  className="absolute left-4 top-4 rounded-full border border-border/70 bg-background/70 px-3 py-1 text-[11px] tram-kicker text-muted-foreground backdrop-blur"
              ...
              <div className="p-5">
                <div
                  className="tram-display text-lg font-semibold"
                  data-testid={`text-product-title-${p.tag.toLowerCase()}`}
                >
                  {p.title}
                </div>
                <div
                  className="mt-1 text-sm text-muted-foreground"
                  data-testid={`text-product-subtitle-${p.tag.toLowerCase()}`}
                >
                  {p.subtitle}
                </div>
                ...
                <div
                  ...
                  data-testid={`row-product-meta-${p.tag.toLowerCase()}`}
                >
    ...
    >
      <div className="grid gap-10 lg:grid-cols-[0.9fr,1.1fr]">
        <div className="rounded-3xl border border-border/70 bg-card p-8 md:p-10 shadow-sm">
          <div
            className="tram-kicker text-xs text-muted-foreground"
            data-testid="text-statement-kicker"
          >
            Brand statement
          </div>
          <h3
            className="tram-display mt-4 text-2xl md:text-3xl font-semibold"
            data-testid="text-statement-title"
          >
          ...
          <p
            ...
            data-testid="text-statement-body"
          >
            We treat wood like a living material: grain direction, movement, and
            finish are considered from the first sketch to the final polish.
            Every commission is crafted to bring warmth and clarity to a
            space—never noise.
          </p>

          <div
            className="mt-8 grid grid-cols-3 gap-5"
            data-testid="grid-statement-stats"
          >
            {[
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/70 bg-card shadow-sm">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <div className="max-w-md">
              <div
                className="tram-kicker text-[10px] text-muted-foreground"
                data-testid="text-materials-kicker"
              >
                Materials
              </div>
              <div
                className="tram-display mt-2 text-xl font-semibold"
                data-testid="text-materials-title"
              >
                Walnut, elm, premium hardwoods.
              </div>
              <div
                className="mt-2 text-sm text-muted-foreground"
                data-testid="text-materials-body"
              >
...
function Footer() {
  return (
    <footer
      className="tram-container mt-16 md:mt-24 pb-14"
      data-testid="footer"
    >
      ...
      <div className="grid gap-10 py-10 md:grid-cols-3">
        ...
        <div className="grid grid-cols-2 gap-8" data-testid="footer-links">
          <div>
            ...
            <div className="mt-3 space-y-2 text-sm">
              <Link
                href="/"
                className="tram-focus block text-foreground/75 hover:text-foreground"
          ...
          <div>
            ...
            <div className="mt-3 space-y-2 text-sm text-foreground/75">
              <div data-testid="text-footer-email">hello@tjmdecor.in</div>
              <div data-testid="text-footer-location">
        ...
        >
          © {new Date().getFullYear()} tramboo studio — Crafted for
          generations.
        </div>
      </div>
    </footer>
